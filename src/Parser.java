...
public class Parser {
    ...
    private Stmt forStatement() {
        ...
        // If we got to here, we are inside the braces and in the body block
        Stmt body = statement();

        // If the increment exists, we need to execute it every time after the body
        if (increment != null) {
        ...
        // Add the initializer to the block of the body
        if (initializer != null) {
    ...
    private Stmt.Function function(String kind) {
        ...
        if (!check(TokenType.RIGHT_PAREN)) {
            do {
                ...
                parameters.add(consume(TokenType.IDENTIFIER, "Expect parameeter name"));
